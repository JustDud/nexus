# go_to_market Playbook 2

## Thesis
For early-stage technical startups, go_to_market decisions should follow an iterative loop: hypothesis -> test -> measurement -> adjustment.
